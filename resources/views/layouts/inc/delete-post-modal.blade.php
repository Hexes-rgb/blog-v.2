    ...
    <div class="modal-dialog" role="document">
      <div class="modal-content rounded-3 shadow">
        ...
        <div class="modal-footer flex-nowrap p-0 text-center">
            <a href="{{ route('change-post-status', ['post_id' => $post->id]) }}"class="w-100" ><button type="button" class="btn btn-lg btn-link fs-6 w-100 text-decoration-none col-6 m-0 rounded-0 border-end delete-post">Yes, delete</button></a>
